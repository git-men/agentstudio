        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="flex-1 relative">
            <textarea
              ...
              className="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none outline-none focus:ring-0 focus-visible:ring-0 focus-visible:outline-none resize-none text-sm chat-textarea-clean"
