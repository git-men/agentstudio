...
(async () => {
  ...
  app.use(helmet({
    contentSecurityPolicy: {
      directives: {
        defaultSrc: ["'self'"],
        scriptSrc: ["'self'", "'unsafe-inline'", "'unsafe-eval'", "https://registry.npmmirror.com", "https://app.posthog.com", "https://us.i.posthog.com", "https://us-assets.i.posthog.com"], // Allow eval for development, CDN for Monaco, PostHog
        styleSrc: ["'self'", "'unsafe-inline'", "https://fonts.googleapis.com", "https://registry.npmmirror.com"],
        fontSrc: ["'self'", "https://fonts.gstatic.com", "https://registry.npmmirror.com", "data:"],
        ...
        workerSrc: ["'self'", "blob:", "https://registry.npmmirror.com"],
        childSrc: ["'self'", "blob:"],
